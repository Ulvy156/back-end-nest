CREATE OR ALTER PROCEDURE [dbo].[CMLDLQ_GetCollectedAmtROTeam]
    @filterType VARCHAR(200) = NULL,
    @brIds VARCHAR(200) = NULL,
...
BEGIN
    ...
    SELECT
        ...
        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'p' AND dbo.fn_CMLDLQ_IsInRangePAR(60, 89, L.Par_Category) = 1
            THEN L.Balance_Amt ELSE 0 END) AS p60_89days,

        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'p' AND dbo.fn_CMLDLQ_IsInRangePAR(90, 180, L.Par_Category) = 1
            THEN L.Balance_Amt ELSE 0 END) AS p90_180days,

        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'p' AND dbo.fn_CMLDLQ_IsInRangePAR(180, 360, L.Par_Category) = 1
            THEN L.Balance_Amt ELSE 0 END) AS p180_360days,

        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'p' AND dbo.fn_CMLDLQ_IsInRangePAR(360, 0, L.Par_Category) = 1
        ...
        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(0, 60, L.Par_Category) = 1
            THEN L.Balance_Amt ELSE 0 END) AS c_less_60days,

        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(60, 89, L.Par_Category) = 1
            THEN L.Balance_Amt ELSE 0 END) AS c60_89days,

        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(90, 180, L.Par_Category) = 1
            THEN L.Balance_Amt ELSE 0 END) AS c90_180days,

        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(180, 360, L.Par_Category) = 1
            THEN L.Balance_Amt ELSE 0 END) AS c180_360days,

        SUM(CASE 
            WHEN dbo.fn_CMLDLQ_MonthStatus(L.contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(360, 0, L.Par_Category) = 1
