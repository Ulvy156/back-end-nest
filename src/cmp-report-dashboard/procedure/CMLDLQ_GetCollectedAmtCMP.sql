...
BEGIN
    ...
    SELECT
		...
		(
			SUM(CASE WHEN dbo.fn_CMLDLQ_MonthStatus(contact_date) = 'p' AND dbo.fn_CMLDLQ_IsInRangePAR(0, 0, Par_Category) = 1 THEN Balance_Amt ELSE 0 END) +
			SUM(CASE WHEN dbo.fn_CMLDLQ_MonthStatus(contact_date) = 'p' AND dbo.fn_CMLDLQ_IsInRangePAR(1, 29, Par_Category) = 1 THEN Balance_Amt ELSE 0 END) +
			SUM(CASE WHEN dbo.fn_CMLDLQ_MonthStatus(contact_date) = 'p' AND dbo.fn_CMLDLQ_IsInRangePAR(30, 59, Par_Category) = 1 THEN Balance_Amt ELSE 0 END) +
			SUM(CASE WHEN dbo.fn_CMLDLQ_MonthStatus(contact_date) = 'p' AND dbo.fn_CMLDLQ_IsInRangePAR(60, 0, Par_Category) = 1 THEN Balance_Amt ELSE 0 END) +
			SUM(CASE WHEN dbo.fn_CMLDLQ_MonthStatus(contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(0, 0, Par_Category) = 1 THEN Balance_Amt ELSE 0 END) +
			SUM(CASE WHEN dbo.fn_CMLDLQ_MonthStatus(contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(1, 29, Par_Category) = 1 THEN Balance_Amt ELSE 0 END) +
			SUM(CASE WHEN dbo.fn_CMLDLQ_MonthStatus(contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(30, 59, Par_Category) = 1 THEN Balance_Amt ELSE 0 END) +
			SUM(CASE WHEN dbo.fn_CMLDLQ_MonthStatus(contact_date) = 'c' AND dbo.fn_CMLDLQ_IsInRangePAR(60, 0, Par_Category) = 1 THEN Balance_Amt ELSE 0 END)
